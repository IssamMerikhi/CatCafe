...
const AutoScrollView = (props) => {
    const { children, onLayout: propsOnLayout, onContentSizeChange: propsOnContentSizeChange, ...rest } = props;
    ...
    return (<ScrollView scrollEnabled={scrollEnabled} onLayout={onLayout} onContentSizeChange={onContentSizeChange} {...rest}>
      {children}
    </ScrollView>);
};
